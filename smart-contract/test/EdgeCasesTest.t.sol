...
contract EdgeCasesTest is Test {
    ...
    // Test paymaster receive function
    // function test_PaymasterReceiveETH() public {
    //     vm.deal(address(this), 10 ether);
    //     (bool success,) = address(paymaster).call{value: 5 ether}("");
        
    //     assertTrue(success, "ETH transfer to paymaster failed");
    //     assertEq(address(paymaster).balance, 5 ether, "Paymaster balance mismatch");
    // }
}