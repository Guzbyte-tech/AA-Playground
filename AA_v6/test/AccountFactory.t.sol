...
contract AccountFactoryTest is Test {
    ...
    function test_GetAddressDeterminism() public {
        ...
        address predicted1 = factory.getPredictedAddress(owner1, salt);
        address predicted2 = factory.getPredictedAddress(owner1, salt);
        
        // Should return same address
        assertEq(predicted1, predicted2, "getPredictedAddress not deterministic");
    ...
    function test_CreateAccount_NewDeployment() public {
        uint256 salt = 0;
        address predicted = factory.getPredictedAddress(owner1, salt);
    ...
    function test_CREATE2_SaltUniqueness() public view {
        ...
        address addr1 = factory.getPredictedAddress(owner1, salt1);
        address addr2 = factory.getPredictedAddress(owner1, salt2);
