...
contract SystemFlowTest is Test {
    ...
    function test_DeploySmartAccountViaFactory() public {
        ...
        address predictedAddr = factory.getPredictedAddress(accountOwner, salt);
    ...
    function test_BuildAndValidateUserOperation() public {
        ...
        // Build UserOperation call data to execute on account
        ...
        // Gas parameters (explicit fields for UserOperation)
        ...
        // Paymaster signs hash over the relevant fields
        ...
        // Validate via account (as called from EntryPoint)
        vm.prank(address(entryPoint));
        uint256 validationData = account.validateUserOp(userOp, userOpHash, 0);
        
        // Expect validation success (0)
    ...
    function test_FullERC4337ExecutionSimulation() public {
        ...
        userOp.nonce = 0;
        userOp.initCode = "";
        userOp.callData = accountCallData;
        ...
        // Execute the call (EntryPoint would call execute, we mimic it)
        vm.prank(address(entryPoint));
    ...
    function test_Security_InvalidSignatureReplay() public {
        ...
        // Validation should fail (non-zero indicates failure or sigFailed flag depending on impl)
        vm.prank(address(entryPoint));
        uint256 validationData = account.validateUserOp(userOp, userOpHash, 0);
